...
class UsageDataManager(private val context: Context) {
    ...
    fun getDailyMetrics(moodScore: Int): UsageMetrics {
        ...
        return UsageMetrics(
            ...
            scrolling_speed_avg = BehavioralAccessibilityService.scrollVelocityAvg,
            scroll_erraticness = BehavioralAccessibilityService.scrollErraticness,
            typing_cps = BehavioralAccessibilityService.typingCps,
            typing_hesitation_ms = BehavioralAccessibilityService.typingHesitationMs,
            backspace_rate = BehavioralAccessibilityService.backspaceCount.toFloat(),
            notification_response_sec = NotificationReactionTracker.averageResponseSec,
            app_switch_count_per_hour = totalAppSwitches / 24,
            usage_consistency_shift = shift,
            typing_pauses_count = BehavioralAccessibilityService.typingPausesCount,
            max_typing_pause_ms = BehavioralAccessibilityService.maxTypingPauseMs,
